...
export const BASE_SEARCH_SERIE_URL = API_URL+"search/tv"+API_KEY+LANG_ES+"&query=";
export const LATEST_MOVIES_URL = API_URL+"movie/now_playing"+API_KEY+LANG_ES+"&region=ES";
export const LATEST_SERIES_URL = API_URL+"tv/on_the_air"+API_KEY+LANG_ES+"&region=ES";
...
export const GET_GENRES_TV_URL = API_URL+"genre/tv/list"+API_KEY+LANG_ES;